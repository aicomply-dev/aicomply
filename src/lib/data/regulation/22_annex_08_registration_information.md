# **Annex VIII** - Information to be Submitted for Registration of High-Risk AI Systems

**Training Note:** This annex specifies the information providers must submit when registering high-risk AI systems in the EU database. Essential for understanding registration requirements and what data will be publicly accessible.
