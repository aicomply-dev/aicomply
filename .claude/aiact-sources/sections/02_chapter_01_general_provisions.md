...
**Training Note:** This chapter defines the scope of the AI Act and provides essential definitions for all AI systems, providers, deployers, and other key terms. Understanding these definitions is critical for determining whether and how the AI Act applies to your organization.
